...
![test](https://github.com/mvelzel/sqls/workflows/test/badge.svg)
...
![code_actions](https://github.com/mvelzel/sqls.vim/blob/master/imgs/sqls_vim_demo.gif)
...
```shell
go install github.com/mvelzel/sqls@latest
```

## Editor Plugins

- [sqls.vim](https://github.com/mvelzel/sqls.vim)
...
<a href="https://github.com/mvelzel/sqls/graphs/contributors">
